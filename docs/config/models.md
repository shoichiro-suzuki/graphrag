...
- If you want a lower-cost indexing path, you can define a separate `gpt-5-nano` completion model and point index workflows at it while keeping query on `gpt-5.4-mini`.
